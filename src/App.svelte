...
<main class="main   h-screen p-16 md:px-0  py-32 md:py-32 flex flex-col items-center  text-fontcolor ">
<div class="wrapper flex items-center flex-col gap-6 md:gap-8">
  <section class="w-full">
  <h1 class="text-link md:text-xl font-bold font-['spinnaker',sans-serif]">Amith Jayapraban</h1>
  <h3 class="text-[.9rem] title md:text-xl mt-2">Frontend developer from Kerala, India.</h3>
  <h6 class="text-[.8rem] md:text-sm mt-4">Currently pursuing MCA from College of Engineering, Trivandrum. <br>
    Passionate about Web and Photography. <br>
    Loves minimalistic designs.
  </h6>

  <div class=" self-start mt-4 ml-[0px] cursor-pointer  gap-4 flex justify-start">
    <a
            ...
            <a
              ...
              target="_blank"
              class="link cursor-pointer rounded-[50%] h-[24px] w-[24px] linkedin"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                stroke="none"
...
>
  <div class="text-fontcolor flex justify-between items-center   ">
    <h1 class="md:text-md text-sm mb-[.1rem] self-justify-start text-left ">
      {i.name}
    </h1>
    ...
    <!-- <div class="flex flex-wrap gap-2 md:gap-3">
      {#each i.tags as t}
          ...
          <div class="fronten  text-xs rounded-[4px]">
            {t}
          </div>
      {/each}
    </div>-->
...
@import url('https://fonts.googleapis.com/css2?family=Spline+Sans+Mono:ital@1&display=swap');
