...
export default function Home() {
  ...
  return (
    <main className=" p-4 py-16 flex flex-col gap-2 items-center text-fontcolor">
      <section className="wrapper self-start bg-grey font-semibold rounded p-1  w-auto h-full  flex  flex-col gap-2">
        <Image
          src="/Amith.jpg"
          width="128"
      ...
      <section className="wrapper self-start font-semibold  bg-grey rounded p-6  w-auto h-full justify-center flex items-center flex-col gap-4">
        ...
        {/* </section>
      <section className="wrapper items-center self-start bg-grey font-semibold rounded p-6  w-auto h-full  flex  flex-col gap-2"> */}
